...
struct Poly {
  ...
  void set5() {
    ...
    verts.push_back(Vec4f(2, 0, 0, 0));
    verts.push_back(Vec4f(0, 2, 0, 0));
    verts.push_back(Vec4f(0, 0, 2, 0));
    verts.push_back(Vec4f(0, 0, 0, 2));
    verts.push_back(Vec4f(gold, gold, gold, gold));

    // verts.push_back(Vec4f(1, 1, 1, -1/sqrt(5)));
    // verts.push_back(Vec4f(1, -1, -1, -1/sqrt(5)));
    // verts.push_back(Vec4f(-1, 1, -1, -1/sqrt(5)));
    // verts.push_back(Vec4f(-1, -1, 1, -1/sqrt(5)));
    // verts.push_back(Vec4f(0, 0, 0, sqrt(5) - 1/sqrt(5)));
